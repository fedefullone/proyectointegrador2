...
VALUES
("Jordan","1 Retro Low OG SP","Travis Scott agrega otro nuevo diseño a su relación de colaboración con Jumpman a través del Air Jordan 1 Low ",curdate(),1,"retro.jpeg","Georgetown"),
("Nike","Dunk Low Retro","Desde el College Colors Program con espíritu escolar hasta la vibrante colección Nike",curdate(),3,"panda.jpeg","White Black"),
